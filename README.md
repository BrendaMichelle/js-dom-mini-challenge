...
**YOUR NOTES**
```
Now that I have access to the header, all I had to do is update the text color style.
```
___________
...
**YOUR NOTES**
```
I made the mistake of trying to loop through a single object. I was doing what I'm supposed to do on the next deliverable here & that took me back a few minutes. Sad face.
```
___________
...
**YOUR NOTES**
```
I'm going to finish this on my own time, I know how to do it but it's going to take some time & I want to pay attention to your lecture & take notes
```
